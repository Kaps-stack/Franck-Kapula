...
class EducationResource extends Resource
{
    ...
    protected static string|\UnitEnum|null $navigationGroup = 'Parcours académique et scolaire';


    protected static string|BackedEnum|null $navigationIcon = Heroicon::OutlinedAcademicCap;


    protected static ?string $modelLabel = 'Parcours académique';


    protected static ?string $pluralModelLabel = 'Parcours académiques';
